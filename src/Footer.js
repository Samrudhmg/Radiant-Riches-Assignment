...
const Footer = () => {
  return (
    <div className='h-[50vh] lg:h-[50vh]  md:h-max md:w-auto md:p-10   lg:p-0 lg:px-[16rem]  lg:py-[2rem] grid items-center justify-center  md:flex lg:flex  md:justify-between lg:justify-between w-auto bg-[#212731] text-[white] md:mt-[4rem] mt-[15rem]'>
